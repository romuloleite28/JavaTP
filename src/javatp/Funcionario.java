...
public class Funcionario extends Pessoa {
    ...
    public Funcionario(int id, String nome, LocalDate dataNascimento, Genero genero, float peso, float altura, String patologias, TipoPessoa tipo, String cargo) {
        super(id, nome, dataNascimento, genero, peso, altura, patologias, tipo, cargo);
    }

    public Pessoa adicionarFuncionario() throws IOException {
        ...
        System.in.read(localCargo);
        String cargo1 = new String(localCargo); // Para o programa não dar skip 
        System.in.read(localCargo);
        String cargo2 = new String(localCargo);

        Pessoa novoFuncionario = new Pessoa(id2, nome2, dataNascimento2, genero1, peso2, altura2, patologias2, tipoPessoa1, cargo2) {
        };
